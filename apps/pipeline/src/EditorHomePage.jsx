...
export default function EditorHomePage({ ads, userName, setPage, activeWorkspaceId, session, myEditorProfile }) {
  ...
  return (
    <div className="animate-fade" style={{ maxWidth: 1100 }}>
      {/* ── WELCOME VIDEO POPUP ── */}
      {showWelcome && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(0,0,0,0.92)" }} onClick={dismissWelcome}>
          <div onClick={e => e.stopPropagation()} style={{
            width: 720, maxWidth: "92vw", background: "#13131a", border: "1px solid var(--border)",
